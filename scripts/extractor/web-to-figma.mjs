...
export async function exportWebToFigma(targetUrl, outputDir = "./extracted-figma") {
  ...
  try {
    ...
    // Create a README explaining how to paste or import into Figma for free
...
2. In the Plugins menu, search for **"Open HTML to Figma"** or **"HTML to Design"** (free tier).
3. Select "Import JSON" and select \`figma-layers.json\`.
